...
<html lang="en">
  <head>
    ...
    <title>${generateTitle(finalTeamArray)} My Team Project - using JEST for test, inquirer prompts and fs </title>
  ...
  <body>
    ...
    <div class="section no-pad-bot" id="index-banner">
      <div class="container">
        <br><br>
        <h1 class="header center orange-text">Team Profile Information - ${finalTeamArray[0]}</h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col l6 s12">
          ...
          <p class="grey-text text-lighten-4">We are a team of coders working on this project like it's our full time job.</p>
        </div>
      </div>
    </div>
    <div class="footer-copyright">
      <div class="container">
      Made by <a class="orange-text text-lighten-3" href="https://anitapeppercorn.github.io/anitaprofileportfolio/">Anita Ganti</a>
      </div>
    </div>
  </footer>
